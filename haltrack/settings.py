"""
Django settings for haltrack project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'halal.context_processors.admin',
                'halal.context_processors.auditor',
                'halal.context_processors.manufaktur',
            ],
        },
    },
]
